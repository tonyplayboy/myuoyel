...
public class UserService {
    ...
    private static final String KEY_PREFIX_CODE = "leyou:user:code:";
    ...
    public Boolean sendVerifyCode(String phone) {
        ...
        try {
            ...
            //3.将code存入redis
            this.stringRedisTemplate.opsForValue().set(KEY_PREFIX_CODE + phone,code,5, TimeUnit.MINUTES);
    ...
    public Boolean register(User user, String code) {
        String key = KEY_PREFIX_CODE + user.getPhone();
        //1.从redis中取出验证码
        ...
        if (result){
            try{
                this.stringRedisTemplate.delete(KEY_PREFIX_CODE + user.getPhone());
            }catch (Exception e){
    ...
    public boolean updatePassword(String username,String oldPassword, String newPassword) {
        ...
        //3.处理缓存中的信息
        BoundHashOperations<String,Object,Object> hashOperations = this.stringRedisTemplate.boundHashOps(KEY_PREFIX_CODE+username);
