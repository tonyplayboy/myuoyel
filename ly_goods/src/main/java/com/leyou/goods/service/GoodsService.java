...
import com.leyou.goods.client.ItemClient;
...
public class GoodsService {
    ...
    public Map<String, Object> loadModel(Long spuId) {
        ...
        //查询商品信息
        SpuBo spuBo = itemClient.queryGoodById(spuId);
        ...
        List<Category> categoryList = itemClient.queryCategoryByIds(ids);

        //查询品牌信息
        Brand brand = itemClient.queryBrandByIds(Collections.singletonList(spuBo.getBrandId())).get(0);
